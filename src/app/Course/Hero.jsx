...
const BusinessAnalytics = ({ dataId }) => {
  ...
  const handleDownload = () => {
    const fileUrl = "https://asmi-veda.s3.ap-southeast-2.amazonaws.com/brochures/1727180185114_Suicide+Prevention+Brochure.pdf"; // Path relative to the public folder
