...
const BusinessAnalytics = ({ dataId }) => {
  ...
  const handleDownload = () => {
    const fileUrl = "https://asmi-veda.s3.ap-southeast-2.amazonaws.com/brochures/1727179455469_Immersion+Brochure.pdf"; // Path relative to the public folder
    const a = document.createElement('a');
    a.href = fileUrl;
    a.download = "IP.PDF"; // The name of the downloaded file
